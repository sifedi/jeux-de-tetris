...
int main()
{
	...
	backgroundTexture.loadFromFile("images/backrounds.png");
	sf::Sprite backgroundSprite(backgroundTexture);
	sf::Texture tile_tex;
	tile_tex.loadFromFile("images/tetris.png");
	...
	//Music
	sf::Music track;
	track.openFromFile("sounds/tetris.wav");
	track.play();
	track.setLoop(true);
	...
	sf::Text score;
	sf::Font font;
	font.loadFromFile("font/Forwa.TTF");
	score.setFont(font);
	...
	sf::RenderWindow window(sf::VideoMode(width, height), "jeux de fedi bouattour", sf::Style::Titlebar | sf::Style::Close);
